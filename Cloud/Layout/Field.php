...
class Cloud_Field {
	...
	protected function setup_information(){
		...
		$value = isset( $_REQUEST[ $name ] ) ? $_REQUEST[ $name ] : '' ; // check $_REQUEST for existing values 		 
	...
	****/
	...
	protected function get_label(){
		$label = "<label class='title' for='".$this->info['prefix'] . $this->info['id'] . "' >" . $this->info['title'] ."</label>";
		return $label;
	}
